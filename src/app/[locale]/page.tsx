...
export default function HomePage() {
	...
	return (
		<div className='min-h-screen'>
				...
				<div className='relative z-20 h-full flex items-center'>
					<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full'>
						<div className='text-center text-white space-y-8'>
							{/* Badge */}
							<div className='inline-block animate-fade-in mt-4'>
								<span className='px-4 py-2 sm:px-5 sm:py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-white text-xs sm:text-sm font-semibold tracking-wide shadow-lg'>
									✨{' '}
									{language === 'hy'
										? 'Հայաստանի #1 Անշարժ Գույքի Հարթակ'
										: language === 'ru'
										? 'Платформа недвижимости #1 в Армении'
										: "Armenia's #1 Real Estate Platform"}
								</span>
							</div>
							...
							<h1 className='text-5xl md:text-7xl lg:text-8xl font-extrabold leading-tight animate-slide-up'>
								...
								<span className='block bg-gradient-to-r from-yellow-400 via-orange-400 to-pink-400 bg-clip-text text-transparent drop-shadow-2xl mt-2'>
									{language === 'hy'
										? 'Կատարյալ Տունը'
										: language === 'ru'
										? 'Идеальный Дом'
							...
							{/* Subtitle */}
							<p className='text-xl md:text-2xl lg:text-3xl text-blue-100 max-w-3xl mx-auto leading-relaxed drop-shadow-lg font-light'>
								{language === 'hy'
									? 'Հազարավոր ստուգված անշարժ գույք, մեկ հարթակում. Ձեր երազանքի տունը սպասում է ձեզ'
									: language === 'ru'
									? 'Тысячи проверенных объектов недвижимости на одной платформе. Дом вашей мечты ждет вас'
									: 'Thousands of verified properties, one platform. Your dream home awaits'}
							</p>
							...
							<div className='pt-4 animate-bounce-slow'>
								<Link
									...
									className='group inline-flex items-center px-6 py-3 sm:px-12 sm:py-6 bg-gradient-to-r from-green-500 via-teal-500 to-blue-500 text-white font-bold rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 text-sm sm:text-xl relative overflow-hidden'
								>
									<span className='absolute inset-0 bg-gradient-to-r from-green-400 via-teal-400 to-blue-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300'></span>
									<span className='relative z-10 flex items-center'>
										<span className='mr-2 sm:mr-4 text-lg sm:text-2xl'>🏡</span>
										{language === 'hy'
											? 'Դիտել Բոլոր Անշարժ Գույքերը'
											: language === 'ru'
											? 'Смотреть Всю Недвижимость'
											: 'View All Properties'}
										<ArrowRight className='ml-2 sm:ml-4 h-5 sm:h-7 w-5 sm:w-7 group-hover:translate-x-2 transition-transform duration-300' />
									</span>
								</Link>
							</div>
						</div>
			...
			<PromoVideoSection language={language} />
			{/* Property Types */}
